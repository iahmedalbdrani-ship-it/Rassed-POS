...
export default function CreateProductComponent() {
  ...
  mutation.mutate({ itemName: ..., sku: ..., costPrice: ..., salePrice: ..., currentStock: ..., vatRate: ..., description: ..., });
...
export default function CreateTransactionComponent() {
  ...
  // Variables can be defined inline as well.
  mutation.mutate({ description: ..., amount: ..., transactionType: ..., vatAmount: ..., referenceNumber: ..., });
